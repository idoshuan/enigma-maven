...
public record Inventory(String name, Alphabet alphabet, Map<Integer, Rotor> rotors, Map<Integer, Reflector> reflectors, int requiredRotorCount) implements Serializable {
