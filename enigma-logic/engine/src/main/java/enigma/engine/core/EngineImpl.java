...
public class EngineImpl implements Engine {
    ...
    public void loadFromFile(String path) {
        loadFromInventory(loader.load(path));
    }

    @Override
    public void loadFromInventory(Inventory inventory) {
        this.inventory = inventory;
        this.machine = new MachineImpl(inventory.alphabet());
        this.codeValidator = new CodeValidator(inventory);
        this.codeDetailsFactory = new CodeDetailsFactory(inventory);
        this.statisticsTracker = new StatisticsTrackerImpl();
        this.initialCode = Optional.empty();
    }
